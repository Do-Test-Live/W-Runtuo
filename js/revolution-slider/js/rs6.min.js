...
!function (e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID, window.RSANYID_sliderID = window.RSANYID_sliderID === t ? [] : window.RSANYID_sliderID, e.fn.extend({
        revolution: function (a) {
            return this.each(function () {
                ...
                i = e.fn.revolution, this.id !== t ? (i[s] = {anyid: []}, this.id = i.revCheckIDS(s, this, !0)) : this.id = "rs_module_" + Math.round(1e7 * Math.random());
                var s = this.id;
        ...
        sA: function (e, t, i) {
            ...
            if (a !== t && i[a] !== t && "clicked" !== i[a].modal.closeProtection) {
                ...
                switch (r.mode) {
                    case"show":
                        ...
                        var o = {a: 0};
                        punchgs.TweenMax.fromTo(o, .01, {a: 0}, {
                            a: 10,
                            ease: punchgs.Power3.easeInOut,
                            onComplete: function () {
                    ...
                    case"init":
                        if (window.RS_60_MODALS = window.RS_60_MODALS === t ? [] : window.RS_60_MODALS, -1 === e.inArray(i[a].modal.alias, window.RS_60_MODALS) && window.RS_60_MODALS.push(i[a].modal.alias), i[a].modal.listener === t) {
                            ...
                            if ("-50%" === s.y && (s.filter = "blur(0px)"), punchgs.TweenMax.set(i[a].modal.c, "auto" === i[a].sliderLayout || "fullscreen" === i[a].sliderLayout ? e.extend(!0, s, {
                                ...
                                for (o in i[a].modal.trigger = {}, l) if (l.hasOwnProperty(o)) switch ((n = l[o].split(":"))[0]) {
                                    case"t":
                                ...
                                if (i[a].modal.trigger.time !== t && 0 !== i[a].modal.trigger.time && setTimeout(function () {
                                    ...
                                    document.addEventListener("scroll", d, {id: a, passive: !0})
                                }
            ...
            return "left" == t ? i : "right" == t ? a : "all" == t ? {left: i, right: a, both: i + a} : i + a
    ...
    var a = i.is_mobile(), r = (i.is_android(), function (e) {
        ...
        if (i[r] !== t) {
            ...
            if (i[r].simplifyAll && (i.isIE(8) || i.iOSVersion()) && (i[r].c.find(".rs-layer").each(function () {
                ...
                var L = i[r].cpar[0].style.marginTop, I = i[r].cpar[0].style.marginBottom;
            ...
            if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({overflow: "visible"}), 0 !== i[r].maxHeight && punchgs.TweenMax.set([i[r].cpar, i[r].c, i[r].topc], {maxHeight: i[r].maxHeight + "px"}), i[r].fixedOnTop && punchgs.TweenMax.set(i[r].topc, {
                position: "fixed",
                top: "0px",
                left: "0px",
                pointerEvents: "none",
                ...
                i[r].c.height(R.height), 0 === i[r].c.find("rs-progress").length && i[r].c.append('<rs-progress style="visibility:hidden"></rs-progress>'), i[r].c.find("rs-progress").css({width: "0%"}), i[r].canvas.css({display: "block"}), b(r), i[r].slides = i[r].canvas.find("rs-slide").not(".rs-not-in-nav"), i[r].inli = i[r].canvas.find("rs-slide.rs-not-in-nav"), ("off" !== i[r].parallax.type || i[r].scrolleffect.set || i[r].sbtimeline.set) && i.checkForParallax && i.checkForParallax(r), i.setSize(r, !1), "hero" !== i[r].sliderType && i.createNavigation && i[r].navigation.use && i.createNavigation(r), i.resizeThumbsTabs && i.resizeThumbsTabs && i[r].navigation.use && i.resizeThumbsTabs(r), g(r);
                var O = i[r].viewPort;
        ...
        i[r].dimensionReCheck = {}, i[r].c.trigger("revolution.slide.beforeredraw"), 1 == i[r].infullscreenmode && (i[r].minHeight = e(window).height()), a && (i[r].lastMobileHeight = window.innerHeight), l(r), i.resizeThumbsTabs && !0 !== i.resizeThumbsTabs(r) || (f(r, !0 !== o), g(r), "carousel" == i[r].sliderType && i.prepareCarousel(r), i.setSize(r), i.updateDimensions(r), "standard" === i[r].sliderType && i[r].mtl !== t && i.animateSlide({
            ...
            i.prepareCarousel(r), i.animateTheLayers({slide: "individual", id: r, mode: "rebuild"})
        ...
        if (i[r] !== t) {
            ...
            i.scrollHandling && i[r].mtl !== t && (i.scrollHandling(r, !0, 0), i[r].mtl.eventCallback("onUpdate", function () {
                ...
                i[r].mtl.resume()
            }, 18), "carousel" !== i[r].sliderType && punchgs.TweenMax.to(i[r].pr_next_slide, .001, {autoAlpha: 1})
        }
    };
    var M = function (r) {
        ...
        i[r].c.on("stoptimer", function () {
            ...
            t[0].tween.pause(), i[r].disableProgressBar && t.css({visibility: "hidden"}), i[r].sliderstatus = "paused", i[r].slideInSwapTimer || i.unToggleState(i[r].slidertoggledby), i[r].slideInSwapTimer = !1
            ...
            if (!i[r].forcepaused) {
                ...
                1 === i[r].noloopanymore || i[r].viewPort.enable && !i[r].inviewport || 1 == i[r].ssop ? i.unToggleState(i[r].slidertoggledby) : (t.css({visibility: "visible"}), t[0].tween.kill(), t[0].tween = punchgs.TweenMax.fromTo(t, i[r].duration / 1e3, {width: "0%"}, {
                    force3D: "auto",
                    width: "100%",
                    ease: punchgs.Linear.easeNone,
                    onComplete: s,
                    delay: 1
                }), i[r].sliderstatus = "playing", i.toggleState(i[r].slidertoggledby)), i[r].disableProgressBar && t.css({visibility: "hidden"}), i[r].mouseoncontainer && 1 == i[r].navigation.onHoverStop && !a && (i[r].c.trigger("stoptimer"), i[r].c.trigger("revolution.slide.onpause"))
            }
        ...
        prepareCarousel: function (e, i, a) {
            if (void 0 !== e) {
                ...
                s.slidepositions = void 0 === s.slidepositions ? [] : s.slidepositions, s.slideFakePositions = void 0 === s.slideFakePositions ? [] : s.slideFakePositions, i = s.lastdirection = o(i, s.lastdirection), r(e), void 0 === s.slidepositions[0] && (t.organiseCarousel(e, "right", !0, !1, !1), s.focused = 0, s.keepFocusedFirst = !0), s.slide_offset = void 0 !== s.slide_offset && jQuery.isNumeric(s.slide_offset) ? s.slide_offset : 0, s.swipeTo = s.slide_offset + n(e), void 0 !== s.swipeTo && jQuery.isNumeric(s.swipeTo) ? void 0 !== a ? t.swipeAnimate({
                    ...
                    fix: !0,
                    speed: a
                }) : t.swipeAnimate({id: e, to: s.swipeTo, direction: i, fix: !0}) : t.swipeAnimate({
                    id: e,
                    to: 0,
                    direction: i,
                    speed: 0
            ...
            if (s.justify) s.focused = void 0 === s.focused ? 0 : s.focused, s.slidepositions[s.focused] = void 0 === s.slidepositions[s.focused] ? 0 : s.slidepositions[s.focused], s.slide_offset_target = i(e, s.focused); else {
                ...
                var n = "center" === s.horizontal_align ? (s.wrapwidth / 2 - s.slide_width / 2 - s.slide_offset) / s.slide_width : (0 - s.slide_offset) / s.slide_width,
                    ...
                    p = -1 * (Math.floor(l) - l), u = d * s.slide_width,
            ...
            var s = t[e].carousel, n = "center" === s.horizontal_align ? 2 : 1,
                ...
                c = Math.ceil(s.maxVisibleItems / n), p = 0, u = 0, h = 0;
            ...
            var f = 999, m = 0, v = (t[e].ulw, !1), y = "right" === s.horizontal_align ? 0 : s.wrapwidth;
    ...
    var i = function (e, i) {
        ...
        if (void 0 === i.wrap && function (e) {
            ...
            for (var o = 0; o < i.len; o++) if (t[e].slides.hasOwnProperty(o)) {
                var s = t.gA(t[e].slides[o], "iratio");
                s = void 0 === s || 0 === s || null === s ? i.ratio : s, i.slide_widths[o] = Math.round(i.slide_height * s), !1 !== i.justifyMaxWidth && (i.slide_widths[o] = Math.min(i.wrapwidth, i.slide_widths[o])), punchgs.TweenLite.set(t[e].slides[o], {width: i.slide_widths[o]}), i.maxwidth += i.slide_widths[o] + i.space
            }
        }
        ...
        var i, a, r, o, n, l = 0, d = t[e].carousel;
        if (void 0 !== d.positionanim && d.positionanim.kill(), d.justify) "center" === d.horizontal_align ? l = d.windhalf - d.slide_widths[d.focused] / 2 - d.slidepositions[d.focused] : "left" === d.horizontal_align ? l = 0 - d.slidepositions[d.focused] : "right" === d.horizontal_align && (l = d.wrapwidth - d.slide_widths[d.focused] - d.slidepositions[d.focused]), l = l > d.maxwidth / 2 ? d.maxwidth - l : l < 0 - d.maxwidth / 2 ? l + d.maxwidth : l; else {
    ...
    "use strict";
    var t = ["chars", "words", "lines"], i = jQuery.fn.revolution, a = i.is_mobile();
    i.is_android();
    jQuery.extend(!0, i, {
        checkLayerDimensions: function (e) {
            ...
            for (var n in i[o].layers[e.skey]) if (i[o].layers[e.skey].hasOwnProperty(n)) {
                var l = i[o].layers[e.skey][n], d = jQuery(l), c = i.gA(l, "initialised") ? i[o]._L[l.id] : d.data();
                ...
                if (void 0 === i.gA(l, "initialised")) {
                    if (i.revCheckIDS(o, l), i[o]._L[l.id] = c, c.ford = void 0 === c.ford ? "frame_0;frame_1;frame_999" : c.ford, c.ford = ";" == c.ford[c.ford.length - 1] ? c.ford.substring(0, c.ford.length - 1) : c.ford, c.ford = c.ford.split(";"), void 0 !== c.clip) for (t in c.clipPath = {
                        use: !1,
                        origin: "l",
                        type: "rectangle"
                    ...
                    }), void 0 !== c.border) for (t in c.border = c.border.split(";"), c.bordercolor = "transparent", c.border) if (c.border.hasOwnProperty(t)) switch ((a = c.border[t].split(":"))[0]) {
                        case"boc":
                            c.bordercolor = a[1];
                            break;
                        case"bow":
                    ...
                    if (void 0 !== c.tsh) for (t in c.tshadow = {
                        c: "rgba(0,0,0,0.25)",
                        v: 0,
                        h: 0,
                        b: 0
                    }, c.tsh = c.tsh.split(";"), c.tsh) if (c.tsh.hasOwnProperty(t)) switch ((a = c.tsh[t].split(":"))[0]) {
                        case"c":
                            c.tshadow.c = a[1];
                            break;
                        case"h":
                    ...
                    if (void 0 !== c.tst) for (t in c.tstroke = {
                        c: "rgba(0,0,0,0.25)",
                        w: 1
                    }, c.tst = c.tst.split(";"), c.tst) if (c.tst.hasOwnProperty(t)) switch ((a = c.tst[t].split(":"))[0]) {
                        case"c":
                            c.tstroke.c = a[1];
                            break;
                        case"w":
                    ...
                    if (void 0 !== c.bsh) for (t in c.bshadow = {
                        e: "c",
                        c: "rgba(0,0,0,0.25)",
                        v: 0,
                        h: 0,
                        b: 0,
                        s: 0
                    }, c.bsh = c.bsh.split(";"), c.bsh) if (c.bsh.hasOwnProperty(t)) switch ((a = c.bsh[t].split(":"))[0]) {
                        case"c":
                            c.bshadow.c = a[1];
                            break;
                        case"h":
                    ...
                    if (void 0 !== c.dim) for (t in c.dim = c.dim.split(";"), c.dim) if (c.dim.hasOwnProperty(t)) switch ((a = c.dim[t].split(":"))[0]) {
                        case"w":
                            c.width = a[1];
                            break;
                        case"h":
                    ...
                    if (void 0 !== c.xy) for (t in c.xy = c.xy.split(";"), c.xy) if (c.xy.hasOwnProperty(t)) switch ((a = c.xy[t].split(":"))[0]) {
                        case"x":
                            c.x = a[1].replace("px", "");
                            break;
                        case"y":
                    ...
                    if (!c._isnotext && void 0 !== c.text) for (t in c.text = c.text.split(";"), c.text) if (c.text.hasOwnProperty(t)) switch ((a = c.text[t].split(":"))[0]) {
                        case"w":
                            c.whitespace = a[1];
                            break;
                        case"td":
                    ...
                    if (void 0 !== c.flcr) for (t in c.flcr = c.flcr.split(";"), c.flcr) if (c.flcr.hasOwnProperty(t)) switch ((a = c.flcr[t].split(":"))[0]) {
                        case"c":
                            c.clear = a[1];
                            break;
                        case"f":
                    ...
                    if (void 0 !== c.padding) for (t in c.padding = c.padding.split(";"), c.padding) if (c.padding.hasOwnProperty(t)) switch ((a = c.padding[t].split(":"))[0]) {
                        case"t":
                            c.paddingtop = a[1];
                            break;
                        case"b":
                    ...
                    if (void 0 !== c.margin) for (t in c.margin = c.margin.split(";"), c.margin) if (c.margin.hasOwnProperty(t)) switch ((a = c.margin[t].split(":"))[0]) {
                        case"t":
                            c.margintop = a[1];
                            break;
                        case"b":
                    ...
                    if (void 0 !== c.spike && (c.spike = A(c.spike)), void 0 !== c.corners) for (t in r = c.corners.split(";"), c.corners = {}, r) r.hasOwnProperty(t) && r[t].length > 0 && (c.corners[r[t]] = jQuery("<" + r[t] + "></" + r[t] + ">"), c.c.append(c.corners[r[t]]));
                ...
                var m = "grid" === c.basealign ? i[o].width : "carousel" !== i[o].sliderType || c._isstatic ? i[o].ulw : i[o].carousel.slide_width,
                    ...
                    y = c.x[i[o].level], b = c.y[i[o].level];
                if (g = "slide" === c.basealign ? 0 : Math.max(0, "fullscreen" == i[o].sliderLayout ? v / 2 - i.iHE(o) * (i[o].keepBPHeight ? 1 : i[o].bh) / 2 : i[o].autoHeight || null != i[o].minHeight && i[o].minHeight > 0 ? i[o].conh / 2 - i.iHE(o) * i[o].bh / 2 : g), h = "slide" === c.basealign ? 0 : Math.max(0, h), "slide" !== c.basealign && "carousel" === i[o].sliderType && c._isstatic && void 0 !== i[o].carousel && void 0 !== i[o].carousel.horizontal_align && (h = Math.max(0, "center" === i[o].carousel.horizontal_align ? 0 + (i[o].ulw - i.iWA(o, "static") * i[o].bw) / 2 : "right" === i[o].carousel.horizontal_align ? i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw : h)), "updateposition" !== e.mode) {
                    if (0 == c.vbility[i[o].levelForced] || "f" == c.vbility[i[o].levelForced] || m < i[o].hideLayerAtLimit && "on" == c.layeronlimit || m < i[o].hideAllLayerAtLimit ? c.p[0].classList.add("rs-layer-hidden") : c.p[0].classList.remove("rs-layer-hidden"), c.poster = null == c.poster && void 0 !== c.thumbimage ? c.thumbimage : c.poster, "image" === c.layertype) if ("cover-proportional" === c.img.data("c")) {
                        ...
                        var z = c.width[i[o].level], O = c.height[i[o].level];
                        ...
                        if (c._incolumn && "100%" === z && "auto" === O && void 0 !== c.ytid) {
                            ...
                            var C = d.width() / c.vd;
                            punchgs.TweenLite.set(d, {height: C + "px"}), c.heightSetByVideo = !0
                            ...
                            width: z,
                            height: O
                        }), (0 == c.html5vid && !R || 1 != c.forcecover && !d.hasClass("rs-fsv") && !R) && (c.media.width(z), c.media.height(O)), c._ingroup && null != z && !jQuery.isNumeric(z) && z.indexOf("%") > 0 && punchgs.TweenMax.set([c.lp, c.p, c.m], {minWidth: z})
                    }
                ...
                if ("preset" !== e.mode) {
                    if (c.eow = d.outerWidth(!0), c.eoh = d.outerHeight(!0), c.eow <= 0 && void 0 !== c.lastknownwidth && (c.eow = c.lastknownwidth), c.eoh <= 0 && void 0 !== c.lastknownheight && (c.eoh = c.lastknownheight), ("text" === c.type || "button" === c.type) && void 0 !== c.corners) {
                        for (r in c.corners) if (c.corners.hasOwnProperty(r)) {
                    ...
                    (1 == i[o].gridEQModule || void 0 !== c._lig && "row" !== c.type && "column" !== c.type && "group" !== c.type) && (Q = void 0 !== c._lig ? c._lig.width() : i[o].ulw, N = void 0 !== c._lig ? c._lig.height() : i[o].ulh, h = 0, g = 0), y = "c" === y || "m" === y || "center" === y || "middle" === y ? Q / 2 - c.eow / 2 + H : "l" === y || "left" === y ? H : "r" === y || "right" === y ? Q - c.eow - H : "off" !== c.rsp_o ? y * i[o].bw : y, b = "m" === b || "c" === b || "center" === b || "middle" === b ? N / 2 - c.eoh / 2 + j : "t" === b || "top" == b ? j : "b" === b || "bottom" == b ? N - c.eoh - j : "off" !== c.rsp_o ? b * i[o].bw : b, y = c._slidelink ? 0 : i[o].rtl && "100%" !== c.width[i[o].level] ? y + c.eow : y, c.calcx = parseInt(y, 0) + h, c.calcy = parseInt(b, 0) + g, "row" !== c.type && "column" !== c.type ? punchgs.TweenMax.set(c.p, {
                        ...
                        left: h,
                        overwrite: "auto"
                    }), c.cbreak <= i[o].level ? d[0].classList.add("rev_break_columns") : d[0].classList.remove("rev_break_columns")), void 0 !== c.blendmode && punchgs.TweenMax.set(c.p, {mixBlendMode: c.blendmode}), void 0 !== c.frames.loop && punchgs.TweenMax.set(c.lp, {
                        width: c.eow,
                        height: c.eoh
                    }), c._ingroup && (void 0 !== c._groupw && !jQuery.isNumeric(c._groupw) && c._groupw.indexOf("%") > 0 && punchgs.TweenMax.set([c.lp, c.p, c.m], {minWidth: c._groupw}), void 0 !== c._grouph && !jQuery.isNumeric(c._grouph) && c._grouph.indexOf("%") > 0 && punchgs.TweenMax.set([c.lp, c.p, c.m], {minHeight: c._grouph})), e.animcompleted && i.animcompleted(d, o)
                }
            }
            ...
            if (void 0 !== a && i[t].layers[a] && i.initLayer({
                ...
                slideIndex: "static",
                mode: "updateposition"
            }), "start" !== e.mode && "preset" !== e.mode || i.manageNavigation(t)), void 0 !== a && i[t].layers[a]) for (var s in i[t].layers[a]) i[t].layers[a].hasOwnProperty(s) && i.renderLayerAnimation({
                layer: jQuery(i[t].layers[a][s]),
                id: t,
                mode: e.mode
            });
            if (i[t].layers.static) for (var s in i[t].layers.static) i[t].layers.static.hasOwnProperty(s) && i.renderLayerAnimation({
            ...
            var a = e.layer, d = e.id, c = i[d].level, p = i[d]._L[a[0].id],
                u = void 0 !== p.timeline ? p.timeline.time() : void 0, f = !1, b = !1, w = "none";
            if ("preset" !== e.mode || !0 === p.frames.frame_1.timeline.waitoncall || void 0 !== p.scrollBasedOffset || !0 === p.forceRender) {
                if ("trigger" == e.mode && (p.triggeredFrame = e.frame), p._isstatic) {
                    var _ = "carousel" === i[d].sliderType && void 0 !== i[d].carousel.oldfocused ? i[d].carousel.oldfocused : void 0 === i[d].pr_lastshown_key ? 1 : parseInt(i[d].pr_lastshown_key, 0) + 1,
                        ...
                        k = _ >= p.startslide && _ <= p.endslide, T = x >= p.startslide && x <= p.endslide;
                    if (w = _ === p.endslide && "continue" === e.mode || ("continue" === e.mode || _ === p.endslide) && "none", !0 === e.allforce || !0 === w) ; else {
                ...
                for (var L in "start" === e.mode && void 0 !== p.layerLoop && (p.layerLoop.count = 0), "start" === e.mode && (e.frame = void 0 === p.triggeredFrame ? 0 : p.triggeredFrame), "continue" !== e.mode && "trigger" !== e.mode && void 0 !== p.timeline && p.timeline.pause(0), "continue" !== e.mode && "trigger" !== e.mode || void 0 === p.timeline || p.timeline.pause(), p.timeline = new punchgs.TimelineMax({paused: !0}), "text" !== p.type && "button" !== p.type || void 0 !== p.splitText && (void 0 !== p.splitTextFix || "start" !== e.mode && "preset" !== e.mode) || (h({
                    layer: a,
                    id: d
                }), "start" === e.mode && (p.splitTextFix = !0)), p.ford) if (p.ford.hasOwnProperty(L)) {
                    var I = p.ford[L], S = !1;
                    if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                        ...
                        if ("frame_999" !== I || !1 !== w || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                            ...
                            var A = p.frames[I], R = p.fff ? p.frames.frame_0 : void 0, z = new punchgs.TimelineMax,
                                O = new punchgs.TimelineMax, M = p.c,
                                C = void 0 !== A.sfx && g(A.sfx.effect, p.m, A.timeline.ease),
                                P = A.timeline.speed / 1e3, j = 0, H = m({
                                    id: d,
                                    frame: A,
                                    layer: a,
                                    ...
                                    splitAmount: M.length,
                                    target: "frame_0"
                                }) : void 0, N = void 0 !== A.mask ? m({
                                    id: d,
                                    frame: {transform: {x: A.mask.x, y: A.mask.y}},
                                    layer: a,
                                    ease: H.ease,
                                    target: "mask"
                                }) : void 0, D = void 0 !== N && p.fff ? m({
                                    id: d,
                            ...
                            "block" === C.type && (C.ft[0].background = A.sfx.fxc, z.add(punchgs.TweenMax.fromTo(C.bmask_in, P / 2, C.ft[0], C.ft[1], 0)), z.add(punchgs.TweenMax.fromTo(C.bmask_in, P / 2, C.ft[1], C.t, P / 2)), "frame_0" === I || "frame_1" === I ? Q.opacity = 0 : "frame_999" === I && z.add(O.staggerFromTo(M, .05, {autoAlpha: 1}, {
                                autoAlpha: 0,
                                delay: P / 2
                            ...
                            var W = 0;
                            if (void 0 !== p.splitText && !1 !== p.splitText) for (var F in t) if (void 0 !== A[t[F]] && !p.quickRendering) {
                                var E = y(p.splitText[t[F]], A[t[F]].dir), Y = m({
                                    id: d,
                                    frame: A,
                                    source: t[F],
                                    ease: B,
                                ...
                                var X = v(jQuery.extend(!0, {}, Y)), Z = p.fff ? v(jQuery.extend(!0, {}, V)) : void 0;
                                delete X.dir, X.data = {splitted: !0}, void 0 !== Z && delete Z.dir, p.fff ? z.add(O.staggerFromTo(E, P, Z, X, p.frames[I].split ? j : 0, 0), 0) : z.add(O.staggerTo(E, P, X, p.frames[I].split ? j : 0, 0), 0), W = E.length > W ? E.length : W
                            }
                            P += p.frames[I].split ? j * W : 0, p.pxundermask || void 0 !== N && (void 0 !== R && "hidden" === R.mask.overflow || "hidden" === A.mask.overflow) ? (z.add(punchgs.TweenMax.to(p.m, .001, {overflow: "hidden"}), 0), "column" === p.type && z.add(punchgs.TweenMax.to(p.cbgmask, .001, {overflow: "hidden"}), 0), p.btrans && (D && (D.rotationX = p.btrans.rX, D.rotationY = p.btrans.rY, D.rotationZ = p.btrans.rZ, D.opacity = p.btrans.o), N.rotationX = p.btrans.rX, N.rotationY = p.btrans.rY, N.rotationZ = p.btrans.rZ, N.opacity = p.btrans.o), p.fff ? z.add(punchgs.TweenMax.fromTo([p.m, p.cbgmask], P, jQuery.extend(!0, {}, D), jQuery.extend(!0, {}, N)), .001) : z.add(punchgs.TweenMax.to([p.m, p.cbgmask], P, jQuery.extend(!0, {}, N)), .001)) : void 0 !== p.btrans ? z.add(punchgs.TweenMax.to(p.m, .001, {
                                x: 0,
                                y: 0,
                                filter: "none",
                                opacity: p.btrans.o,
                            ...
                            p.timeline.addLabel(I, q), p.timeline.add(z, q), p.timeline.addLabel(I + "_end", "+=0.01"), z.eventCallback("onStart", o, [{
                                ...
                                frame: I,
                                L: a
                            }]), z.eventCallback("onComplete", n, [{id: d, frame: I, L: a}])
                        }
                    }
                }
                if (void 0 !== p.frames.loop) {
                    var U = p.frames.loop.frame_0, G = p.frames.loop.frame_999, J = new punchgs.TimelineMax({}),
                        K = new punchgs.TimelineMax({repeat: -1, yoyo: p.frames.loop.timeline.yoyo_move}),
                        $ = new punchgs.TimelineMax({repeat: -1, yoyo: p.frames.loop.timeline.yoyo_rotate}),
                        ee = new punchgs.TimelineMax({repeat: -1, yoyo: p.frames.loop.timeline.yoyo_scale}),
                        te = new punchgs.TimelineMax({repeat: -1, yoyo: p.frames.loop.timeline.yoyo_filter}),
                        ie = parseInt(p.frames.loop.timeline.speed, 0) / 1e3,
                        ae = parseInt(p.frames.loop.timeline.start) / 1e3 || 0, re = ae + .2;
                    if (J.add(K, 0), J.add($, 0), J.add(ee, 0), J.add(te, 0), G.originX = U.originX, G.originY = U.originY, G.originZ = U.originZ, p.frames.loop.timeline.curved) {
                        var oe = parseInt(p.frames.loop.timeline.radiusAngle, 0) || 0,
                            se = [{x: (U.x - U.xr) * i[d].bw, y: 0, z: (U.z - U.zr) * i[d].bw}, {
                                x: 0,
                                y: (U.y + U.yr) * i[d].bw,
                                z: 0
                            }, {x: (G.x + G.xr) * i[d].bw, y: 0, z: (G.z + G.zr) * i[d].bw}, {
                                x: 0,
                                y: (G.y - G.yr) * i[d].bw,
                                z: 0
                            }], ne = {
                    ...
                    ce = 0 === ce ? 1e-5 : ce, p.hoverlistener || (p.hoverlistener = !0, jQuery(document).on("mouseenter mousemove", ("column" === p.type ? "#" + p.cbg[0].id + "," : "") + "#" + p.c[0].id, function (e) {
                        if (("mousemove" !== e.type || !0 !== p.ignoremousemove) && p.readyForHover) {
                            if (p.ignoremousemove = !0, p.elementHovered = !0, p.hovertimeline || (p.hovertimeline = new punchgs.TimelineMax), p.hovertimeline.to([p.m, p.cbgmask], ce, {overflow: p.frames.frame_hover.mask ? "hidden" : "visible"}, 0), "column" === p.type && p.hovertimeline.to(p.cbg, ce, jQuery.extend(!0, {}, l(p.frames.frame_hover, p.cbg)), 0), p.hovertimeline.pause(), "text" !== p.type && "button" !== p.type || void 0 === p.splitText || !1 === p.splitText || p.hovertimeline.to([p.splitText.lines, p.splitText.words, p.splitText.chars], ce, {
                                ...
                                p.svgHTemp.fill = t, p.hovertimeline.to(p.svg, ce, p.svgHTemp, 0), p.hovertimeline.to(p.svgPath, ce, {fill: t}, 0)
                            }
                ...
                if (S || (p.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? e.frame : p.lastRequestedMainFrame), void 0 !== e.totime ? p.tSTART = e.totime : void 0 !== u && void 0 === e.frame ? p.tSTART = u : void 0 !== e.frame ? p.tSTART = e.frame : p.tSTART = 0, 0 === p.tSTART && void 0 === p.startedAnimOnce && void 0 === p.leftstage && void 0 === p.startedAnimOnce && !0 === p.hideonfirststart && "preset" === e.mode && (i[d]._L[a[0].id].p[0].classList.add("rs-forcehidden"), p.hideonfirststart = !1), "frame_999" !== p.tSTART && "frame_999" !== p.triggeredFrame || !p.leftstage && void 0 !== p.startedAnimOnce) {
                    if ("true" != p.animationonscroll && 1 != p.animationonscroll ? p.timeline.play(p.tSTART) : p.timeline.time(p.tSTART), jQuery.inArray(p.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        if (void 0 === p.childrenJS) for (var F in p.childrenJS = {}, i[d]._L) void 0 !== i[d]._L[F]._lig && void 0 !== i[d]._L[F]._lig[0] && i[d]._L[F]._lig[0].id === a[0].id && i[d]._L[F]._lig[0].id !== i[d]._L[F].c[0].id && (p.childrenJS[i[d]._L[F].c[0].id] = i[d]._L[F].c);
                        ...
                        if (!0 === e.updateChildren) for (var F in p.childrenJS) p.childrenJS.hasOwnProperty(F) && i.renderLayerAnimation({
                            ...
                            updateChildren: !0,
                            totime: pe
                        }); else for (var F in p.childrenJS) p.childrenJS.hasOwnProperty(F) && i[d]._L[F].pausedTrueParrent && (i.renderLayerAnimation({
                            layer: p.childrenJS[F],
                            fastforward: !1,
                            id: d,
                            mode: "continue",
    ...
    var r = function (e) {
        ...
        if (void 0 === window.rdF0) {
            ...
            window.rdF0 = window.rdF1 = {
                ...
                chars: jQuery.extend(!0, {blur: 0, grayscale: 0, brightness: 100}, s),
                words: jQuery.extend(!0, {blur: 0, grayscale: 0, brightness: 100}, s),
                lines: jQuery.extend(!0, {blur: 0, grayscale: 0, brightness: 100}, s)
        ...
        for (var o in void 0 === e.frame_0 && (e.frame_0 = "x:0"), void 0 === e.frame_1 && (e.frame_1 = "x:0"), e.ford) if (e.ford.hasOwnProperty(o)) {
            var n = e.ford[o];
            if (e[n]) {
        ...
        var l, d, c, p, u = L(e, t), h = "off" === r ? 1 : i[t].bw, g = "off" === r ? 1 : i[t].bh,
            f = "column" !== s.type ? {t: u.marginTop, b: u.marginBottom, l: u.marginLeft, r: u.marginRight} : {
                t: 0,
                b: 0,
                l: 0,
                r: 0
        ...
        if ("column" === s.type && punchgs.TweenMax.set(s._column, {
            ...
            if (s._incolumn || (v.marginTop = "row" === s.type ? 0 : f.t * g + "px", v.marginBottom = "row" === s.type ? 0 : f.b * g + "px", v.marginLeft = "row" === s.type ? 0 : f.l * h + "px", v.marginRight = "row" === s.type ? 0 : f.r * h + "px"), void 0 !== s.spike && (v["clip-path"] = v["-webkit-clip-path"] = s.spike), u.boxShadow && (v.boxShadow = u.boxShadow), "column" !== s.type && (void 0 !== u.borderStyle && "none" !== u.borderStyle && (0 !== u.borderTopWidth || u.borderBottomWidth > 0 || u.borderLeftWidth > 0 || u.borderRightWidth > 0) ? (v.borderTopWidth = Math.round(u.borderTopWidth * g) + "px", v.borderBottomWidth = Math.round(u.borderBottomWidth * g) + "px", v.borderLeftWidth = Math.round(u.borderLeftWidth * h) + "px", v.borderRightWidth = Math.round(u.borderRightWidth * h) + "px", v.borderStyle = u.borderStyle, v.borderTopColor = u.borderTopColor, v.borderBottomColor = u.borderBottomColor, v.borderLeftColor = u.borderLeftColor, v.borderRightColor = u.borderRightColor) : ("none" === u.borderStyle && (v.borderStyle = "none"), v.borderTopColor = u.borderTopColor, v.borderBottomColor = u.borderBottomColor, v.borderLeftColor = u.borderLeftColor, v.borderRightColor = u.borderRightColor)), "shape" !== s.type && "image" !== s.type || 0 === u.borderTopLeftRadius && 0 === u.borderTopRightRadius && 0 === u.borderBottomLeftRadius && 0 === u.borderBottomRightRadius || (v.overflow = "hidden"), s._isnotext || ("column" !== s.type && (v.fontSize = Math.round(u.fontSize * h) + "px", v.fontWeight = u.fontWeight, v.letterSpacing = u.letterSpacing * h + "px", u.textShadow && (v.textShadow = u.textShadow), u.textStroke && (v["-webkit-text-stroke"] = u.textStroke)), v.lineHeight = Math.round(u.lineHeight * g) + "px", v.textAlign = u.textAlign), "column" === s.type && (void 0 === s.cbg_set && (s.cbg_set = s.styleProps["background-color"], s.cbg_set = "" == s.cbg_set || void 0 === s.cbg_set || 0 == s.cbg_set.length ? "transparent" : s.cbg_set, s.cbg_img = e.css("backgroundImage"), s.cbg_img_r = e.css("backgroundRepeat"), s.cbg_img_p = e.css("backgroundPosition"), s.cbg_img_s = e.css("backgroundSize"), s.cbg_o = s.bgopacity ? 1 : s.bgopacity, punchgs.TweenMax.set(e, {
                ...
                backgroundImage: ""
            })), v.backgroundColor = "transparent", v.backgroundImage = "none"), s._isstatic && s.elementHovered && (l = e.data("frames")) && l.frame_hover && l.frame_hover.transform) for (d in v) v.hasOwnProperty(d) && l.frame_hover.transform.hasOwnProperty(d) && delete v[d];
    ...
    var r = function (e, i) {
        ...
        n = "swipebased" == r && "vertical" == d ? "none" : r ? "vertical" : n, jQuery.fn.swipetp || (jQuery.fn.swipetp = jQuery.fn.swipe), jQuery.fn.swipetp.defaults && jQuery.fn.swipetp.defaults.excludedElements || jQuery.fn.swipetp.defaults || (jQuery.fn.swipetp.defaults = {}), jQuery.fn.swipetp.defaults.excludedElements = "label, button, input, select, textarea, .noSwipe", s.swipetp({
            ...
            swipeStatus: function (r, s, n, c, p, u, h) {
                var g = l("RS-MODULE", r), f = l("RS-THUMB", r), m = l("RS-TAB", r),
                    v = this[0].className.indexOf("tp-tabs") >= 0 || this[0].className.indexOf("tp-thumb") >= 0,
                    y = "start" === s ? 0 : r.pageX - o.screenX, b = "start" === s ? 0 : r.pageY - o.screenY;
                if (!("carousel" === t[a].sliderType && t[a].carousel.wrapwidth > t[a].carousel.maxwidth && "center" !== t[a].carousel.horizontal_align)) if ("carousel" !== t[a].sliderType || ("move" !== s && "end" !== s && "cancel" != s || !t[a].dragStartedOverSlider || t[a].dragStartedOverThumbs || t[a].dragStartedOverTabs) && ("start" !== s || !g || f || m)) {
                    ...
                    var w = t[a].dragStartedOverThumbs ? ".tp-thumbs" : ".tp-tabs",
                        ...
                        L = e.parent().find(_), I = L.find(x), S = T.direction,
                        A = "vertical" === S ? I.height() : I.width(), R = "vertical" === S ? L.height() : L.width(),
                        z = "vertical" === S ? L.find(k).first().outerHeight(!0) + T.space : L.find(k).first().outerWidth(!0) + T.space,
                        O = void 0 === I.data("offset") ? 0 : parseInt(I.data("offset"), 0), M = 0;
                    switch (s) {
                        case"start":
                        ...
                        case"move":
                            ...
                            M = M < C ? "horizontal" === S ? M + I.width() * (M - C) / I.width() * (M - C) / I.width() : M + I.height() * (M - C) / I.height() * (M - C) / I.height() : M, "vertical" === S ? punchgs.TweenLite.set(I, {top: M + "px"}) : punchgs.TweenLite.set(I, {left: M + "px"});
                            break;
                        case"end":
                        case"cancel":
    ...
    jQuery.extend(!0, t, {
        preparePanZoom: function (e) {
            ...
            if (void 0 !== s.panzoom && null !== s.panzoom) {
                ...
                var h = e.data("pzimg"), g = h.parent(), f = function (e, t, i) {
            ...
            if (void 0 !== t[e]) {
                ...
                if (_.set && (!i || !1 === _.disable_onmobile)) {
                    ...
                    if (!1 !== _.bgs) {
                        ...
                        for (var A in "top" == _.direction && c >= 0 && (k = 1), "bottom" == _.direction && c <= 0 && (k = 1), k = k > 1 ? 1 : k < 0 ? 0 : k, _.bgs) if (_.bgs.hasOwnProperty(A)) {
    ...
    var i = function (e, t) {
        ...
        if (0 == d) {
            ...
            var I = new punchgs.TimelineLite, S = p / 1e3 - p / 1e3 / t[a].slots;
            ...
            var A = t[a].pr_next_bg[0].getElementsByClassName("slotslide"), R = p - p / 1.8;
            for (k = 0; k < A.length; k++) t[a].mtl.add(punchgs.TweenLite.fromTo(A[k], (p - k * (R / t[a].slots)) / 1e3, {
                opacity: 0,
                force3D: "auto",
                transformPerspective: 600
            }, {opacity: 1, ease: "Linear.easeNone", delay: k * (R / t[a].slots) / 1e3}), 0)
        } else if (11 == d) {
            ...
            var C = 3 == l.trC ? p / 1300 : p / 1e3, P = p / 1e3, j = 5 == l.trC || 6 == l.trC ? 0 : t[a].width,
                H = 5 == l.trC || 6 == l.trC ? 0 : t[a].currentSlideHeight, Q = 12 == d ? j : 15 == d ? 0 - j : 0,
                N = 13 == d ? 5 == l.trC || 6 == l.trC ? 0 : t[a].height : 14 == d ? 5 == l.trC || 6 == l.trC ? 0 : 0 - t[a].height : 0,
                D = 1 == l.trC || 2 == l.trC || 5 == l.trC || 6 == l.trC ? 0 : 1,
                B = 4 == l.trC || 5 == l.trC ? .6 : 6 == l.trC ? 1.4 : 1, W = 5 == l.trC ? 1.4 : 6 == l.trC ? .6 : 1;
            if (7 != l.trC && 4 != l.trC || (j = 0, H = 0), 8 == l.trC ? (t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_active_slide, {zIndex: 20}), 0), t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_next_slide, {zIndex: 15}), 0), t[a].mtl.add(punchgs.TweenLite.to(t[a].pr_next_bg, .01, {
                overflow: "hidden",
                left: 0,
                top: 0,
                x: 0,
            ...
            var E = 25 === d ? t[a].rotate : 1 === n ? 90 : -90, Y = 25 === d ? 1 === n ? -90 : 90 : t[a].rotate;
            ...
            t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, p / 1e3, {
                ...
                transformPerspective: 1200,
                force3D: "auto"
            }, {immediateRender: !0, rotationX: Y, transformOrigin: F, rotationY: E, ease: f}), 0)
            ...
            var V = t[a].pr_next_bg.find(".slot"), X = 27 == d || 29 == d ? "-100%" : "+100%",
                Z = 27 == d || 29 == d ? "+100%" : "-100%", q = 27 == d || 29 == d ? "-80%" : "80%",
                U = 27 == d || 29 == d ? "+80%" : "-80%", G = 27 == d || 29 == d ? "+10%" : "-10%",
    ...
    var r = function (e, t, i) {
        ...
        if (n.ifr = e.find("iframe"), s(a, e), n.ifr.attr("id", d), n.startvideonow = r, n.videolistenerexist) {
            ...
            case"vimeo":
                ...
                var x, k = t.is_mobile() || t.isSafari11(), T = "RS-BGVIDEO" === e[0].tagName;
